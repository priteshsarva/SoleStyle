  ...
  return (
    <>
      ...
      <div className="sticky  top-0 z-50">
              ...
              <div className="px-4 pt-2 pb-3 space-y-1">
                ...
                {navLinks.map((link) => (
                  <Link
                    ...
                    className={`block px-3 py-2 text-base font-medium rounded-md transition-colors ${location.pathname === link.to
        ...
        {/* Main Header */}
        <header className={`bg-white transition-all duration-300 ${isScrolled ? 'shadow-md' : 'border-b border-gray-100'
          }`}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
